...
impl VShader {
    ...
    pub fn new_textured(renderer: &StateInstance) -> Self {
        let shader = renderer
            .device
            .create_shader_module(wgpu::include_wgsl!("../shaders/textured_shader.wgsl"));
        Self::new::<UVVertex>(
            renderer,
            shader,
            1,
    ...
    pub fn new_textured_envmap(renderer: &StateInstance) -> Self {
        let shader = renderer.device.create_shader_module(wgpu::include_wgsl!(
            "../shaders/textured_shader_envmap.wgsl"
        ));
        Self::new::<UVVertex>(
            renderer,
            shader,
    ...
    pub fn new_displacement(renderer: &StateInstance) -> Self {
        let shader = renderer
            .device
            .create_shader_module(wgpu::include_wgsl!("../shaders/displacement.wgsl"));
        Self::new::<UVVertex>(
            renderer,
            shader,
            2,
    ...
    pub fn new_white_lines<V: Vertex>(renderer: &StateInstance) -> Self {
        let shader = renderer
            .device
            .create_shader_module(wgpu::include_wgsl!("../shaders/solid_white.wgsl"));
        Self::new::<V>(
            renderer,
            shader,
            0,
    ...
    pub fn new_instanced_prop<V: Vertex, I: Vertex>(renderer: &StateInstance) -> Self {
        let shader = renderer
            .device
            .create_shader_module(wgpu::include_wgsl!("../shaders/uv_shader.wgsl"));
